...
$(document).ready(function() {
  ...
  $("#resultsButton").click(function(event) {
      if (chooseLang(Q1, Q2, Q3, Q4, Q5)==="Swift") {
      ...
      else if (chooseLang(Q1, Q2, Q3, Q4, Q5)==="Python") {
      ...
      else if (chooseLang(Q1, Q2, Q3, Q4, Q5)==="Java") {
      ...
      else if (chooseLang(Q1, Q2, Q3, Q4, Q5)==="JavaScript") {
    ...
    $("#bestLanguage").empty().append(languageRec);
